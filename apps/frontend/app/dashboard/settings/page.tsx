...
export default function SettingsPage(): ReactElement {
  ...
  return (
    <div className="space-y-12">
      <header>
        <h1 className="text-axiom-24 font-medium text-text-primary">Settings</h1>
        <p className="mt-2 text-axiom-15 text-text-secondary">Display preferences</p>
      </header>

      <section className="space-y-4">
        <h2 className="font-mono text-axiom-16 font-medium uppercase tracking-[1px] text-text-primary">
          Font size
        </h2>
        <div>
          <div className="mb-2 text-axiom-15 text-text-secondary">Choose a comfortable reading size for the dashboard.</div>
